...
Documentation topics:<br />
 ...
 &nbsp; &nbsp;  &nbsp; &nbsp; [Multiple Database Connections](https://github.com/shayanderson/pdom#multiple-database-connections), [Pagination](https://github.com/shayanderson/pdom#pagination)<br />
...
$r = pdom('users(fullname, email)', 'WHERE is_active = :active AND fullname = :name LIMIT 2', <br />['active' => 1, 'name' => 'Shay Anderson']);
```
...
$r = pdom('users(fullname, email)', 'WHERE is_active = ? AND fullname = ? LIMIT 2', <br />[1, 'Shay Anderson']);
```
